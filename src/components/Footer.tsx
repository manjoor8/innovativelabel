      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 border-b border-white/10">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 mt-2">
            <a href="#" className="hover:text-red-400 text-white/60 transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="#" className="hover:text-red-400 text-white/60 transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm text-white/70">
            {footerLinks.products.map((link) => (
              <li key={link.name}>
                <Link href={link.href} className="hover:text-red-400 hover:underline transition-all">
                  {link.name}
                </Link>
              </li>
            ))}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="flex flex-col">
              <a href="mailto:info@labelsolutions.in" className="hover:text-red-400 hover:underline">
                info@labelsolutions.in
              </a>
              <a href="mailto:sales@labelsolutions.in" className="hover:text-red-400 hover:underline">
